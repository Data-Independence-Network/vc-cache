...
pub static URL_THIS_MONTHS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "4";
pub static URL_THIS_WEEKS_LOCATION_POLL_RANKINGS: &str = "5";
pub static URL_THIS_WEEKS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "5";
pub static URL_TODAYS_LOCATION_POLL_RANKINGS: &str = "6";
pub static URL_TODAYS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "6";


pub static URL_LAST_MONTHS_LOCATION_POLL_RANKINGS: &str = "7";
pub static URL_LAST_MONTHS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "7";
pub static URL_LAST_WEEKS_LOCATION_POLL_RANKINGS: &str = "8";
pub static URL_LAST_WEEKS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "8";
pub static URL_YESTERDAYS_LOCATION_POLL_RANKINGS: &str = "9";
pub static URL_YESTERDAYS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "9";
pub static URL_DAY_BEFORE_YESTERDAY_LOCATION_POLL_RANKINGS: &str = "_";
pub static URL_DAY_BEFORE_YESTERDAY_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "_";
