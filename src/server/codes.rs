...
pub const RESPONSE_INVALID_CATEGORY_CACHE_INDEX_FLAG: u8 = 4;
pub const RESPONSE_INVALID_GLOBAL_LOCATION_ID_FLAG: u8 = 8;
pub const RESPONSE_INVALID_LOCATION_CACHE_INDEX_FLAG: u8 = 16;
pub const RESPONSE_INVALID_PERIOD_ID_FLAG: u8 = 32;
pub const RESPONSE_INVALID_TIMEZONE_ID_FLAG: u8 = 64;
...
pub const URL_THIS_MONTHS_LOCATION_POLL_RANKINGS: &str = "4";
pub const URL_THIS_MONTHS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "5";
pub const URL_THIS_WEEKS_LOCATION_POLL_RANKINGS: &str = "6";
pub const URL_THIS_WEEKS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "7";
pub const URL_TODAYS_LOCATION_POLL_RANKINGS: &str = "8";
pub const URL_TODAYS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "9";


pub const URL_LAST_MONTHS_LOCATION_POLL_RANKINGS: &str = "a";
pub const URL_LAST_MONTHS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "b";
pub const URL_LAST_WEEKS_LOCATION_POLL_RANKINGS: &str = "c";
pub const URL_LAST_WEEKS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "d";
pub const URL_YESTERDAYS_LOCATION_POLL_RANKINGS: &str = "e";
pub const URL_YESTERDAYS_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "f";
pub const URL_DAY_B4_YESTERDAY_LOCATION_POLL_RANKINGS: &str = "g";
pub const URL_DAY_B4_YESTERDAY_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "h";
...
pub const URL_THIS_MONTHS_LOCATION_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "E";
pub const URL_THIS_MONTHS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_CACHE_INDEX_AND_GLOBAL_CATEGORY_ID: &str = "F";
pub const URL_THIS_MONTHS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_AND_CATEGORY_CACHE_INDEXES: &str = "G";
pub const URL_THIS_WEEKS_LOCATION_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "H";
pub const URL_THIS_WEEKS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_CACHE_INDEX_AND_GLOBAL_CATEGORY_ID: &str = "I";
pub const URL_THIS_WEEKS_LOCATION_CATEGORY_POLL_RANKINGS: &str = "J";
pub const URL_TODAYS_LOCATION_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "K";
pub const URL_TODAYS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_CACHE_INDEX_AND_GLOBAL_CATEGORY_ID: &str = "L";
pub const URL_TODAYS_LOCATION_CATEGORY_POLL_RANKINGS: &str = "M";


pub const URL_LAST_MONTHS_LOCATION_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "N";
pub const URL_LAST_MONTHS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_CACHE_INDEX_AND_GLOBAL_CATEGORY_ID: &str = "O";
pub const URL_LAST_MONTHS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_AND_CATEGORY_CACHE_INDEXES: &str = "P";
pub const URL_LAST_WEEKS_LOCATION_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "Q";
pub const URL_LAST_WEEKS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_CACHE_INDEX_AND_GLOBAL_CATEGORY_ID: &str = "R";
pub const URL_LAST_WEEKS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_AND_CATEGORY_CACHE_INDEXES: &str = "S";
pub const URL_YESTERDAYS_LOCATION_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "T";
pub const URL_YESTERDAYS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_CACHE_INDEX_AND_GLOBAL_CATEGORY_ID: &str = "U";
pub const URL_YESTERDAYS_LOCATION_CATEGORY_POLL_RANKINGS_BY_LOCATION_AND_CATEGORY_CACHE_INDEXES: &str = "V";
pub const URL_DAY_B4_YESTERDAY_LOCATION_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "W";
...
pub const URL_DAY_B4_YESTERDAY_LOCATION_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_LOCATION_AND_CATEGORY_CACHE_INDEXES: &str = "Y";
