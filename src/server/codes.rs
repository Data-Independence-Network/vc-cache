...
pub static URL_DAY_BEFORE_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "y";
pub static URL_DAY_BEFORE_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "z";
