...
pub static RESPONSE_INVALID_GLOBAL_CATEGORY_ID_FLAG: u8 = 2;
pub static RESPONSE_INVALID_CATEGORY_CACHE_INDEX_FLAG: u8 = 4;
pub static RESPONSE_INVALID_GLOBAL_LOCATION_ID_FLAG: u8 = 8;
pub static RESPONSE_INVALID_LOCATION_CACHE_INDEX_FLAG: u8 = 16;
pub static RESPONSE_INVALID_PERIOD_ID_FLAG: u8 = 32;
...
pub static URL_DAY_B4_YESTERDAY_LOCATION_POLL_RANKINGS: &str = "g";
pub static URL_DAY_B4_YESTERDAY_LOCATION_POLL_RANKINGS_BY_INDEX: &str = "h";
...
pub static URL_THIS_MONTHS_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "m";
pub static URL_THIS_MONTHS_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "n";
pub static URL_THIS_WEEKS_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "o";
pub static URL_THIS_WEEKS_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "p";
pub static URL_TODAYS_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "q";
pub static URL_TODAYS_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "r";


pub static URL_LAST_MONTHS_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "s";
pub static URL_LAST_MONTHS_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "t";
pub static URL_LAST_WEEKS_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "u";
pub static URL_LAST_WEEKS_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "v";
pub static URL_YESTERDAYS_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "w";
pub static URL_YESTERDAYS_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "x";
pub static URL_DAY_B4_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_GLOBAL_ID: &str = "y";
pub static URL_DAY_B4_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_CACHE_INDEX: &str = "z";
...
pub static URL_DAY_B4_YESTERDAY_LOCATION_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_GLOBAL_LOCATION_AND_CATEGORY_IDS: &str = "W";
pub static URL_DAY_B4_YESTERDAY_LOCATION_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_LOCATION_CACHE_INDEX_AND_GLOBAL_CATEGORY_ID: &str = "X";
pub static URL_DAY_B4_YESTERDAY_LOCATION_YESTERDAY_CATEGORY_POLL_RANKINGS_BY_LOCATION_AND_CATEGORY_CACHE_INDEXES: &str = "Y";
